                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      SliderTheme(
                                                                          ...
                                                                          child: Slider(
                                                                            ...
                                                                            inactiveColor:
                                                                                Color(0xFF8D8E98),
                                                                            divisions:
                                                                                task.quantityOfWork - task.unitsDone,
                                                                            label:
                                                                                workDone.toInt().toString() + " units",
                                                                            min:
                                                                                task.unitsDone.toDouble(),
                                                                            max:
                                                                                task.quantityOfWork.toDouble(),
                                                                            value:
                                                                                workDone,
                                                                            onChanged:
                                                                                (val) {
                                                                      ...
                                                                      Row(
                                                                          ...
                                                                          children: <
                                                                              Widget>[
                                                                            Text(workDone.toInt().toString(),
                                                                                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                                                                            Text(
                                                                              " / " + task.quantityOfWork.toString() + " Completed",
